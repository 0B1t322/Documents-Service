...
import (
	...
	"github.com/0B1t322/Documents-Service/document/internal/dto/documents"
...
func (mapper) GetDocumentsReq(params documents.GetDocumentsParams) dto.GetDocumentsDto {
